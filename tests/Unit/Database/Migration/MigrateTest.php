...
namespace Volunteersystem\Test\Unit\Database\Migration;

use Volunteersystem\Application;
use Volunteersystem\Database\Migration\Direction;
use Volunteersystem\Database\Migration\Migrate;
...
{
    /**
     * @covers \Volunteersystem\Database\Migration\Migrate::__construct
     * @covers \Volunteersystem\Database\Migration\Migrate::getMigrations
     * @covers \Volunteersystem\Database\Migration\Migrate::run
     * @covers \Volunteersystem\Database\Migration\Migrate::setOutput
     * @covers \Volunteersystem\Database\Migration\Migrate::mergeMigrations
     */
    ...
    /**
     * @covers \Volunteersystem\Database\Migration\Migrate::getMigrated
     * @covers \Volunteersystem\Database\Migration\Migrate::getMigrationFiles
     * @covers \Volunteersystem\Database\Migration\Migrate::getTableQuery
     * @covers \Volunteersystem\Database\Migration\Migrate::initMigration
     * @covers \Volunteersystem\Database\Migration\Migrate::migrate
     * @covers \Volunteersystem\Database\Migration\Migrate::setMigrated
     * @covers \Volunteersystem\Database\Migration\Migrate::lockTable
     * @covers \Volunteersystem\Database\Migration\Migrate::unlockTable
     */
