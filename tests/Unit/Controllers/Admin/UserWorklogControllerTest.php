...
use Carbon\Carbon;
use Volunteersystem\Controllers\Admin\UserWorklogController;
...
class UserWorklogControllerTest extends ControllerTest
{
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::editWorklog
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::needsUser
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::editWorklog
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::__construct
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::showEditWorklog
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::saveWorklog
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::needsUser
     */
    ...
    public function testSaveNewWorklog(): void
    {
        ...
        $this->assertEquals($description, $new_worklog->description);
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::showDeleteWorklog
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::deleteWorklog
     * @covers \Volunteersystem\Controllers\Admin\UserWorklogController::needsUser
     */
    ...
    public function invalidSaveWorklogParams(): array
    {
        ...
        return [
            // missing work_date
            [['work_hours' => 3.14, 'description' => 'com']],
            // missing work_hours
            [['work_date' => $today, 'description' => 'com']],
            // missing description
            [['work_date' => $today, 'work_hours' => 3.14]],
            // too low work_hours
            [['work_date' => $today, 'work_hours' => -.1, 'description' => 'com']],
            // too low work_hours
            [['work_date' => $today, 'work_hours' => 3.14, 'description' => str_repeat('X', 201)]],
        ];
    }
