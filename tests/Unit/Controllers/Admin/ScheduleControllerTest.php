...
use Volunteersystem\Controllers\Admin\ScheduleController;
...
use Volunteersystem\Helpers\Schedule\Event as EventData;
use Volunteersystem\Helpers\Schedule\Room as RoomData;
use Volunteersystem\Helpers\Schedule\Schedule as ScheduleData;
...
class ScheduleControllerTest extends ControllerTest
{
    ...
    protected VolunteerType $volunteerType;
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::index
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::__construct
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::edit
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::save
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::save
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::delete
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::fireDeleteShiftEvents
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::deleteEvent
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::loadSchedule
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::getScheduleData
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::importSchedule
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::getScheduleData
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::patchSchedule
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::newRooms
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::shiftsDiff
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::getScheduleShiftsByGuid
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::getScheduleShiftsWhereNotGuid
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::eventFromScheduleShift
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::fireUpdateShiftUpdateEvent
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::getAllLocations
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::createLocation
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::createEvent
     * @covers \Volunteersystem\Controllers\Admin\ScheduleController::updateEvent
     */
    ...
    public function setUp(): void
    {
        ...
        $this->volunteerType = VolunteerType::factory()->create();
        ...
        $firstShift->neededVolunteerTypes()->create(['volunteer_type_id' => $this->volunteerType->id, 'count' => 3]);

        $this->user = User::factory()->create();
        // Shift from import
        ShiftEntry::factory()->create([
            'shift_id' => $firstShift->id,
            'volunteer_type_id' => $this->volunteerType->id,
