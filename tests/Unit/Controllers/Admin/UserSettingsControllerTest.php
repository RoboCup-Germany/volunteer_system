...
use Volunteersystem\Controllers\Admin\UserSettingsController;
...
class UserSettingsControllerTest extends ControllerTest
{
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::certificate
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::certificate
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::isIfsgSupporter
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::isDriverLicenseSupporter
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::__construct
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::certificate
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::checkPermission
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::getUser
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::view
     */
     ...
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::isIfsgSupporter
     */
    public function testCertificateByVolunteerTypeSupporter(): void
    {
        config(['ifsg_enabled' => true]);
        ...
        $this->user->userVolunteerTypes()->attach($volunteerType, ['supporter' => true]);
     ...
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::isDriverLicenseSupporter
     */
    public function testDriverLicenseByVolunteerTypeSupporter(): void
    {
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::saveIfsgCertificate
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::saveDrivingLicense
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Admin\UserSettingsController::settingsMenu
     */
