...
use Carbon\Carbon;
use Volunteersystem\Controllers\Metrics\Stats;
...
class StatsTest extends TestCase
{
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::vouchers
     * @covers \Volunteersystem\Controllers\Metrics\Stats::vouchersQuery
     * @covers \Volunteersystem\Controllers\Metrics\Stats::__construct
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::vouchersBuckets
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::goodies
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::tshirtSizes
     * @covers \Volunteersystem\Controllers\Metrics\Stats::raw
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::languages
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::themes
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::licenses
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::worklogSeconds
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::worklogBuckets
     * @covers \Volunteersystem\Controllers\Metrics\Stats::getBuckets
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::locations
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::volunteerTypes
     */
    public function testVolunteerTypes(): void
    {
        (new VolunteerType(['id' => 1, 'name' => 'VolunteerType 1', 'restricted' => true]))->save();
        (new VolunteerType(['id' => 2, 'name' => 'Second VolunteerType', 'restricted' => false]))->save();
        (new VolunteerType(['id' => 3, 'name' => 'Another VolunteerType', 'restricted' => true]))->save();
        (new VolunteerType(['id' => 4, 'name' => 'Old VolunteerType', 'restricted' => false]))->save();
        UserVolunteerType::factory()->create(['volunteer_type_id' => 1, 'confirm_user_id' => 1, 'supporter' => true]);
        UserVolunteerType::factory()->create(['volunteer_type_id' => 1, 'confirm_user_id' => null, 'supporter' => false]);
        UserVolunteerType::factory()->create(['volunteer_type_id' => 1, 'confirm_user_id' => 1, 'supporter' => false]);
        UserVolunteerType::factory()->create(['volunteer_type_id' => 2, 'confirm_user_id' => null, 'supporter' => true]);
        UserVolunteerType::factory()->create(['volunteer_type_id' => 2, 'confirm_user_id' => null, 'supporter' => false]);
        UserVolunteerType::factory()->create(['volunteer_type_id' => 2, 'confirm_user_id' => null, 'supporter' => false]);

        $stats = new Stats($this->database);
        $this->assertEquals([
            [
                'name' => 'VolunteerType 1',
                'restricted' => true,
                'supporters' => 1,
                'confirmed' => 1,
                'unconfirmed' => 1,
            ...
            [
                'name' => 'Second VolunteerType',
                'restricted' => false,
                'unconfirmed' => 0,
                'supporters' => 1,
                'confirmed' => 2,
            ],
            ], $stats->volunteerTypes());
    }

    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::volunteerTypesSum
     */
    public function testVolunteerTypesSum(): void
    {
        (new VolunteerType(['name' => 'VolunteerType 1']))->save();
        (new VolunteerType(['name' => 'Second VolunteerType']))->save();
        (new VolunteerType(['name' => 'Another VolunteerType']))->save();
        (new VolunteerType(['name' => 'Old VolunteerType']))->save();

        $stats = new Stats($this->database);
        $this->assertEquals(4, $stats->volunteerTypesSum());
    }

    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::shiftTypes
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::shifts
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::announcements
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::comments
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::questions
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::usersState
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::usersInfo
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::forceActiveUsers
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::forceFoodUsers
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::usersPronouns
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::email
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::currentlyWorkingUsers
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::faq
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::messages
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::sessions
     * @covers \Volunteersystem\Controllers\Metrics\Stats::getQuery
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::oauth
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::databaseRead
     * @covers \Volunteersystem\Controllers\Metrics\Stats::databaseWrite
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::logEntries
     */
    ...
    /**
     * @covers \Volunteersystem\Controllers\Metrics\Stats::passwordResets
     */
    ...
    protected function addUser(
        ...
        $user = new User([
            'name'     => $name,
            'password' => '',
            'email'    => $name . '@volunteer.example.com',
            'api_key'  => '',
        ]);
        $user->save();
