...
class HtmlEngineTest extends TestCase
{
    ...
    /**
     * @covers \Volunteersystem\Renderer\HtmlEngine::get
     */
    ...
    /**
     * @covers \Volunteersystem\Renderer\HtmlEngine::canRender
     */
    ...
    {
        $tmpFileName = tempnam(sys_get_temp_dir(), 'VolunteersystemUnitTest');
