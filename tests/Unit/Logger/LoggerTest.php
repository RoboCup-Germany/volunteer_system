...
class LoggerTest extends ServiceProviderTest
{
    ...
    /**
     * @covers \Volunteersystem\Logger\Logger::__construct
     */
    ...
    /**
     * @covers       \Volunteersystem\Logger\Logger::log
     * @covers       \Volunteersystem\Logger\Logger::createEntry
    ...
    /**
     * @covers       \Volunteersystem\Logger\Logger::interpolate
     * @covers       \Volunteersystem\Logger\Logger::log
    ...
    /**
     * @covers \Volunteersystem\Logger\Logger::checkLevel
     * @covers \Volunteersystem\Logger\Logger::log
     */
    ...
    /**
     * @covers \Volunteersystem\Logger\Logger::formatException
     * @covers \Volunteersystem\Logger\Logger::log
     */
