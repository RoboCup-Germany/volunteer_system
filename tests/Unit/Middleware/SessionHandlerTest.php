...
use Volunteersystem\Middleware\SessionHandler;
...
{
    /**
     * @covers \Volunteersystem\Middleware\SessionHandler::__construct
     * @covers \Volunteersystem\Middleware\SessionHandler::process
     */
