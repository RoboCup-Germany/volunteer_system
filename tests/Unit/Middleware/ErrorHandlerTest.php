...
use Volunteersystem\Middleware\ErrorHandler;
...
{
    /**
     * @covers \Volunteersystem\Middleware\ErrorHandler::__construct
     * @covers \Volunteersystem\Middleware\ErrorHandler::process
     * @covers \Volunteersystem\Middleware\ErrorHandler::selectView
     */
    ...
    /**
     * @covers \Volunteersystem\Middleware\ErrorHandler::process
     * @covers \Volunteersystem\Middleware\ErrorHandler::redirectBack
     */
