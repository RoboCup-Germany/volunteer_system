...
use Volunteersystem\Middleware\ApiRouteHandler;
...
class ApiRouteHandlerTest extends TestCase
{
    ...
    /**
     * @covers       \Volunteersystem\Middleware\ApiRouteHandler::process
     * @covers       \Volunteersystem\Middleware\ApiRouteHandler::processApi
     * @covers       \Volunteersystem\Middleware\ApiRouteHandler::__construct
