...
use Volunteersystem\Test\Unit\Middleware\Stub\ControllerImplementation;
...
{
    /**
     * @covers \Volunteersystem\Middleware\RequestHandler::__construct
     */
    ...
    /**
     * @covers \Volunteersystem\Middleware\RequestHandler::process
     */
    ...
    /**
     * @covers \Volunteersystem\Middleware\RequestHandler::resolveRequestHandler
     */
    public function testResolveRequestHandler(): void
    {
        ...
        $className = 'Volunteersystem\\Controllers\\FooBarTestController';
    ...
    /**
     * @covers \Volunteersystem\Middleware\RequestHandler::checkPermissions
     * @covers \Volunteersystem\Middleware\RequestHandler::process
     */
