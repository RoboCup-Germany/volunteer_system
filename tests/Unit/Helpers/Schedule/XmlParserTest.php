...
use Volunteersystem\Helpers\Schedule\XmlParser;
...
{
    /**
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::load
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseXml
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseGenerator
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseConferenceColor
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseTracks
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseEvents
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::parseRecording
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::getFirstXpathContent
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::getListFromSequence
     * @covers \Volunteersystem\Helpers\Schedule\XmlParser::getSchedule
     */
    public function testLoad(): void
    {
        ...
        $this->assertEquals('Volunteersystem', $generator->getName());
