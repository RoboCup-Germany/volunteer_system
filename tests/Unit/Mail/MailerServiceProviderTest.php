...
use Volunteersystem\Mail\Mailer;
use Volunteersystem\Mail\MailerServiceProvider;
...
class MailerServiceProviderTest extends ServiceProviderTest
{
    protected array $defaultConfig = [
        'app_name' => 'Volunteersystem App',
        'email'    => [
            'driver'   => 'mail',
            'from'     => [
                'name'    => 'Volunteersystem',
    ...
    /**
     * @covers \Volunteersystem\Mail\MailerServiceProvider::register
     */
    public function testRegister(): void
    {
        ...
        $this->assertExistsInContainer(['mailer', VolunteersystemMailer::class, Mailer::class], $app);

        /** @var VolunteersystemMailer $mailer */
        $mailer = $app->get('mailer');
        $this->assertEquals('Volunteersystem App', $mailer->getSubjectPrefix());
        $this->assertEquals('Volunteersystem', $mailer->getFromName());
    ...
    /**
     * @covers       \Volunteersystem\Mail\MailerServiceProvider::getTransport
    ...
    /**
     * @covers \Volunteersystem\Mail\MailerServiceProvider::getSmtpTransport
     */
