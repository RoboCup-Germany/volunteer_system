...
class RefactorPermissionsAndGroups extends Migration
{
    ...
    protected int $user;
    protected int $userVolunteertypes;
    protected int $userShifts;

    protected string $shiftentry = 'shiftentry_edit_volunteertype_supporter';
    ...
    public function __construct(SchemaBuilder $schema)
    {
        ...
        $this->userVolunteertypes = $this->getPrivilegeId('admin_user_volunteertypes');
    ...
    public function up(): void
    {
        ...
        $this->movePermission($this->userVolunteertypes, $this->bureaucrat, $this->shiCo);
    ...
    public function down(): void
    {
        $this->insertPermission(
            $this->shiftentry,
            'If user with this privilege is volunteertype supporter, he can put users in shifts for their volunteertype',
            $this->volunteer
        );
        $this->insertPermission(
            $this->language,
        ...
        $this->movePermission($this->userVolunteertypes, $this->shiCo, $this->bureaucrat);
