...
class FillPrivilegesAndGroupsRelatedTables extends Migration
{
    ...
    public function up(): void
    {
        ...
        $db->table('groups')
            ->insert([
                ['id' => 10, 'name' => 'Guest'],
                ['id' => 20, 'name' => 'Volunteer'],
                ['id' => 30, 'name' => 'Welcome Volunteer'],
                ['id' => 35, 'name' => 'Voucher Volunteer'],
        ...
        $db->table('privileges')
            ->insert([
                ...
                ['id' => 5, 'name' => 'register', 'description' => 'Einen neuen Volunteer registerieren'],
                ['id' => 6, 'name' => 'admin_rooms', 'description' => 'Räume administrieren'],
                ['id' => 7, 'name' => 'admin_volunteer_types', 'description' => 'Volunteer Typen administrieren'],
                ...
                ['id' => 16, 'name' => 'admin_user', 'description' => 'Administrate the volunteers'],
                ...
                ['id' => 25, 'name' => 'user_shifts_admin', 'description' => 'Signup other volunteers for shifts.'],
                ['id' => 26, 'name' => 'user_myshifts',
                    'description' => 'Allow volunteers to view their own shifts and cancel them.'],
                ['id' => 27, 'name' => 'admin_arrive', 'description' => 'Mark volunteers when they arrive.'],
                ['id' => 28, 'name' => 'admin_shifts', 'description' => 'Create shifts'],
                ['id' => 30, 'name' => 'ical', 'description' => 'iCal shift export'],
                ['id' => 31, 'name' => 'admin_active',
                    'description' => 'Mark volunteers as active and if they got a t-shirt.'],
                ['id' => 32, 'name' => 'admin_free', 'description' => 'Show a list of free/unemployed volunteers.'],
                ['id' => 33, 'name' => 'admin_user_volunteertypes', 'description' => 'Confirm restricted volunteer types'],
                ['id' => 34, 'name' => 'atom', 'description' => ' Atom news export'],
                ['id' => 35, 'name' => 'shifts_json_export', 'description' => 'Export shifts in JSON format'],
                ['id' => 36, 'name' => 'volunteertypes', 'description' => 'View volunteertypes'],
                ['id' => 37, 'name' => 'user_volunteertypes', 'description' => 'Join volunteertypes.'],
                ...
                ['id' => 41, 'name' => 'shiftentry_edit_volunteertype_supporter',
                    'description' => 'If user with this privilege is volunteertype supporter, '
                        . 'he can put users in shifts for their volunteertype'],
        ...
        // Volunteer, ShiCo, Team coordinator, Bureaucrat, Dev
