...
// Volunteertypes
$route->addGroup('/volunteertypes', function (RouteCollector $route): void {
    $route->get('/about', 'VolunteerTypesController@about');
});
    ...
    function (RouteCollector $route): void {
        ...
        $route->addGroup(
            ...
            function (RouteCollector $route): void {
                ...
                $route->get('/volunteertypes', 'Api\VolunteerTypeController@index');
                $route->get('/volunteertypes/{volunteertype_id:\d+}/shifts', 'Api\ShiftsController@entriesByVolunteertype');
                $route->get('/volunteertypes/{volunteertype_id:\d+}/users', 'Api\UsersController@entriesByVolunteertype');
                ...
                $route->get('/users/{user_id:(?:\d+|self)}/volunteertypes', 'Api\VolunteerTypeController@ofUser');
