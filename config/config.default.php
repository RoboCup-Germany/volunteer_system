...
return [
    ...
    'database'                => [
        ...
        'database' => env('MYSQL_DATABASE', 'volunteersystem'),
    ...
    'app_name'                => env('APP_NAME', 'Volunteersystem'),
    ...
    'header_items'            => [
        // Name can be a translation string, permission is an volunteersystem privilege
        // 'Name' => 'URL',
    ...
    'footer_items'            => [
        // Name can be a translation string, permission is a volunteersystem privilege
        // 'Name' => 'URL',
        // 'some.key' => ['URL', 'permission'],
    ...
    'documentation_url'       => env('DOCUMENTATION_URL', 'https://volunteersystem.de/doc/'),
    ...
    'email'                   => [
        ...
        'from'   => [
            ...
            'name'    => env('MAIL_FROM_NAME', env('APP_NAME', 'Volunteersystem')),
        ],
    ...
    'oauth'                   => [
        ...
        '[name]' => [
            ...
            'name' => 'RC Volunteer System',
            // Auth client ID
            'client_id' => 'volunteersystem',
            // Auth client secret
            'client_secret' => env('OAUTH_CLIENT_SECRET'),
            // Authentication URL
            'url_auth' => env('OAUTH_URL_AUTH'),
            // Token URL
            'url_token' => env('OAUTH_URL_TOKEN'),
            // User info URL which provides userdata
            'url_info' => env('OAUTH_URL_INFO'),
            // OAuth Scopes
            // 'scope' => ['openid'],
            ...
            'groups' => 'groups',
            // Groups to team (volunteer type) mapping (optional)
            'teams' => [
                '/Lorem' => 4, // 4 being the ID of the team (volunteer type)
                '/Foo Mod' => ['id' => 5, 'supporter' => true], // 5 being the ID of the team (volunteer type)
            ], */
        ],
    ],
    ...
    'themes' => [
        0 => [
            'name' => 'Volunteersystem light',
            'type' => 'light',
            'navbar_classes' => 'navbar-light bg-light',
        ],
        1 => [
            'name' => 'Volunteersystem dark',
            'type' => 'dark',
    ...
    // Must be one of news, meetings, user_shifts, volunteer types, questions
    ...
    // Supporters of a team (volunteer type) can promote other users of the team (volunteer type) to supporter
    ...
    'night_shifts'            => [
        ...
        'start'      => env('NIGHT_SHIFTS_START', 20), // Starting from hour
    ...
    // A list of credits
    'credits'                 => [
        'Contribution' => 'Please visit [volunteersystem/volunteersystem](https://github.com/volunteersystem/volunteersystem) if '
            . 'you want to contribute, have found any [bugs](https://github.com/volunteersystem/volunteersystem/issues) '
            . 'or need help.',
    ],
