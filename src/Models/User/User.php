...
namespace Volunteersystem\Models\User;
 ...
 * @property-read Collection|VolunteerType[]        $userVolunteerTypes
...
class User extends BaseModel
{
    ...
    {
        return $this
            ->belongsToMany(VolunteerType::class, 'user_volunteer_type')
            ->using(UserVolunteerType::class)
            ->withPivot(UserVolunteerType::getPivotAttributes());
    }

    public function isVolunteerTypeSupporter(VolunteerType $volunteerType): bool
    {
        return $this->userVolunteerTypes()
            ->wherePivot('volunteer_type_id', $volunteerType->id)
