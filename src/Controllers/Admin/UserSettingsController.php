...
class UserSettingsController extends BaseController
{
    ...
    {
        return (bool) VolunteerType::whereRequiresIfsgCertificate(true)
            ->leftJoin('user_volunteer_type', 'user_volunteer_type.volunteer_type_id', 'volunteer_types.id')
            ->where('user_volunteer_type.user_id', $this->auth->user()?->id)
    ...
    {
        return (bool) VolunteerType::whereRequiresDriverLicense(true)
            ->leftJoin('user_volunteer_type', 'user_volunteer_type.volunteer_type_id', 'volunteer_types.id')
            ->where('user_volunteer_type.user_id', $this->auth->user()?->id)
            ->where('user_volunteer_type.supporter', true)
            ->count();
