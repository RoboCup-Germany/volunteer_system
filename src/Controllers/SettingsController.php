...
class SettingsController extends BaseController
{
    ...
    {
        return $this->auth->user()->userVolunteerTypes->filter(function (VolunteerType $volunteerType) {
            return $volunteerType->requires_driver_license;
        })->isNotEmpty();
    }
    ...
    {
        return $this->auth->user()->userVolunteerTypes->filter(function (VolunteerType $volunteerType) {
            return $volunteerType->requires_ifsg_certificate;
        })->isNotEmpty();
    }
