...
class Controller extends BaseController
{
    ...
    public function metrics(): Response
    {
        ...
        $volunteerTypes = [];
        foreach ($this->stats->volunteerTypes() as $volunteerType) {
            $volunteerTypes[] = [
                'labels' => [
                    'name' => $volunteerType['name'],
                    'restricted' => $volunteerType['restricted'],
                    'members' => 'unconfirmed',
                ], 'value' => $volunteerType['unconfirmed'],
            ];
            $volunteerTypes[] = [
                'labels' => [
                    'name' => $volunteerType['name'],
            ...
            $volunteerTypes[] = [
                'labels' => [
                    ...
                    'restricted' => $volunteerType['restricted'],
                    'members' => 'supporters',
                ], 'value' => $volunteerType['supporters'],
            ];
        }
        ...
        $data = [
            ...
            'volunteer_types'          => ['type' => 'gauge', 'help' => 'Volunteer types with member states'] + $volunteerTypes,
            'volunteer_types_sum'      => ['type' => 'gauge', $this->stats->volunteerTypesSum()],
