...
class FeedController extends BaseController
{
    ...
    public function shifts(): Response
    {
        ...
        foreach ($shiftEntries as $entry) {
            $shift = $entry->shift;
            // Data required for the Fahrplan app integration https://github.com/johnjohndoe/volunteersystem
            // See volunteersystem-base/src/main/kotlin/info/metadude/kotlin/library/volunteersystem/models/Shift.kt
