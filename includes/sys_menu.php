...
use Volunteersystem\UserHintsRenderer;
...
function header_render_hints()
{
    ...
    if ($user) {
        ...
        $hints_renderer->addHint(user_volunteertypes_unconfirmed_hint());
...
function make_navigation(): array
{
    ...
    $pages = [
        ...
        'volunteertypes'     => 'volunteertypes.volunteertypes',
    ...
    $admin_pages = [
        ...
        'admin_active'       => 'Active volunteers',
        'users'              => ['All Volunteers', 'admin_user'],
        'admin_free'         => 'Free volunteers',
