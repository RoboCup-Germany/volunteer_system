...
use Volunteersystem\Helpers\BarChart;
...
{
    return auth()->can('admin_arrive') ? __('Arrive volunteers') : __('Volunteers');
}
    ...
    if ($admin_arrive) {
        ...
        if (
            ...
            if ($user_source) {
                ...
                volunteersystem_log('User set to not arrived: ' . User_Nick_render($user_source, true));
                success(__('Reset done. Volunteer has not arrived.'));
            ...
            if ($user_source) {
                ...
                volunteersystem_log('User set as arrived: ' . User_Nick_render($user_source, true));
                success(__('Volunteer has been marked as arrived.'));
