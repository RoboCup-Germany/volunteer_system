...
/**
 * BO to represent if there are free slots on a shift for a given volunteertype
...
class ShiftSignupState
{
    ...
    private function valueForState(ShiftSignupStatus $state)
    {
        return match ($state) {
            ...
            ShiftSignupStatus::VOLUNTEERTYPE, ShiftSignupStatus::COLLIDES => 70,
    ...
    /**
     * How many places are free in this shift for the volunteertype?
     *
     * @return int
     */
