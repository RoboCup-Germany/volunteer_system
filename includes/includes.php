...
$includeFiles = [
    ...
    __DIR__ . '/../includes/model/NeededVolunteerTypes_model.php',
    ...
    __DIR__ . '/../includes/view/VolunteerTypes_view.php',
    ...
    __DIR__ . '/../includes/view/UserVolunteerTypes_view.php',
    __DIR__ . '/../includes/view/UserHintsRenderer.php',
    __DIR__ . '/../includes/view/User_view.php',

    __DIR__ . '/../includes/controller/volunteertypes_controller.php',
    ...
    __DIR__ . '/../includes/controller/user_volunteertypes_controller.php',
